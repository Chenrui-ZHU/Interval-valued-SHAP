...
def _load(biochemtapepath="datasets/nhanes/DU4800.txt", medexamtapepath='datasets/nhanes/DU4233.txt', 
         anthropometrypath="datasets/nhanes/DU4111.txt", vitlpath="datasets/nhanes/N92vitl.txt"):
    '''
